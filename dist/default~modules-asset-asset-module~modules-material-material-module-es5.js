(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-asset-asset-module~modules-material-material-module"], {
    /***/
    "+rOU": function rOU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "/1cH": function cH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _MatAutocompleteBase = /*#__PURE__*/function (_MatAutocompleteMixin) {
        ...
        var _super11 = _createSuper(_MatAutocompleteBase);
        ...
        function _MatAutocompleteBase(_changeDetectorRef, _elementRef, defaults, platform) {
          ...
          _this9._activeOptionChanges = rxjs__WEBPACK_IMPORTED_MODULE_5__["Subscription"].EMPTY;
          /** Whether the autocomplete panel should be visible, depending on option length. */

          _this9.showPanel = false;
          _this9._isOpen = false;
          /** Function that maps an option's control value to its display value in the trigger. */

          _this9.displayWith = null;
          /** Event that is emitted whenever an option from the list is selected. */

          _this9.optionSelected = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
          /** Event that is emitted when the autocomplete panel is opened. */

          _this9.opened = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
          /** Event that is emitted when the autocomplete panel is closed. */

          _this9.closed = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
          /** Emits whenever an option is activated using the keyboard. */

          _this9.optionActivated = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
          _this9._classList = {};
          /** Unique ID to be used by autocomplete trigger's "aria-owns" property. */

          _this9.id = "mat-autocomplete-".concat(_uniqueAutocompleteIdCounter++); // TODO(crisbeto): the problem that the `inertGroups` option resolves is only present on
          // Safari using VoiceOver. We should occasionally check back to see whether the bug
          // wasn't resolved in VoiceOver, and if it has, we can remove this and the `inertGroups`
          // option altogether.

          _this9.inertGroups = (platform === null || platform === void 0 ? void 0 : platform.SAFARI) || false;
          _this9._autoActiveFirstOption = !!defaults.autoActiveFirstOption;
          return _this9;
        }
        ...
        _createClass(_MatAutocompleteBase, [{
          ...
          value: function ngAfterContentInit() {
            ...
            this._activeOptionChanges = this._keyManager.change.subscribe(function (index) {
              _this10.optionActivated.emit({
                source: _this10,
                option: _this10.options.toArray()[index] || null
              });
      ...
      var MatAutocomplete = /*#__PURE__*/function (_MatAutocompleteBase2) {
        ...
        function MatAutocomplete() {
          ...
          _this11._visibleClass = 'mat-autocomplete-visible';
          _this11._hiddenClass = 'mat-autocomplete-hidden';
          return _this11;
        }
      ...
      var MatAutocompleteOrigin = /*#__PURE__*/function (_MatAutocompleteOrigi) {
        ...
        var _super13 = _createSuper(MatAutocompleteOrigin);
        ...
        function _MatAutocompleteTriggerBase(_element, _overlay, _viewContainerRef, _zone, _changeDetectorRef, scrollStrategy, _dir, _formField, _document, _viewportRuler, _defaults) {
          ...
          this.optionSelections = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["defer"])(function () {
            if (_this12.autocomplete && _this12.autocomplete.options) {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["merge"]).apply(void 0, _toConsumableArray(_this12.autocomplete.options.map(function (option) {
            ...
            return _this12._zone.onStable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["switchMap"])(function () {
        ...
        _createClass(_MatAutocompleteTriggerBase, [{
          ...
          value: function ngAfterViewInit() {
            ...
            if (typeof window !== 'undefined') {
              this._zone.runOutsideAngular(function () {
                return window.addEventListener('blur', _this13._windowBlurHandler);
              });
            }
          }
        }, {
          ...
          value: function _getOutsideClickStream() {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["merge"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["fromEvent"])(this._document, 'click'), Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["fromEvent"])(this._document, 'auxclick'), Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["fromEvent"])(this._document, 'touchend')).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["filter"])(function (event) {
              ...
              var clickTarget = _this15._isInsideShadowRoot && event.composedPath ? event.composedPath()[0] : event.target;
              var formField = _this15._formField ? _this15._formField._elementRef.nativeElement : null;
              var customOrigin = _this15.connectedTo ? _this15.connectedTo.elementRef.nativeElement : null;
              return _this15._overlayAttached && clickTarget !== _this15._element.nativeElement && (!formField || !formField.contains(clickTarget)) && (!customOrigin || !customOrigin.contains(clickTarget)) && !!_this15._overlayRef && !_this15._overlayRef.overlayElement.contains(clickTarget);
            }));
      ...
      var MatAutocompleteTrigger = /*#__PURE__*/function (_MatAutocompleteTrigg) {
        ...
        var _super14 = _createSuper(MatAutocompleteTrigger);
        ...
        function MatAutocompleteTrigger() {
          ...
          _this19 = _super14.apply(this, arguments);
          _this19._aboveClass = 'mat-autocomplete-panel-above';
          return _this19;
        }
          ...
          value: function ngAfterViewInit() {
            ...
            if (this._platform.isBrowser) {
              ...
              this._ngZone.runOutsideAngular(function () {
                ...
                Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(window, 'resize').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["auditTime"])(16), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(_this23._destroyed)).subscribe(function () {
    ...
    "qFsG": function qFsG(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatInput = /*#__PURE__*/function (_MatInputMixinBase2) {
        ...
        _formField) {
          ...
          _this25 = _super16.call(this, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
          _this25._elementRef = _elementRef;
          _this25._platform = _platform;
          _this25.ngControl = ngControl;
          _this25._autofillMonitor = _autofillMonitor;
          _this25._formField = _formField;
          _this25._uid = "mat-input-".concat(nextUniqueId++);
          /**
          ...
          _this25.stateChanges = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
          /**
           * Implemented as part of MatFormFieldControl.
           * @docs-private
           */

          _this25.controlType = 'mat-input';
          /**
           * Implemented as part of MatFormFieldControl.
           * @docs-private
           */

          _this25.autofilled = false;
          _this25._disabled = false;
          _this25._required = false;
          _this25._type = 'text';
          _this25._readonly = false;
          _this25._neverEmptyInputTypes = ['date', 'datetime', 'datetime-local', 'month', 'time', 'week'].filter(function (t) {
            return Object(_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_3__["getSupportedInputTypes"])().has(t);
          });
          var element = _this25._elementRef.nativeElement;
          ...
          _this25._inputValueAccessor = inputValueAccessor || element;
          _this25._previousNativeValue = _this25.value; // Force setter to be called in case id was not specified.

          _this25.id = _this25.id; // On some versions of iOS the caret gets stuck in the wrong place when holding down the delete
          ...
          _this25._isServer = !_this25._platform.isBrowser;
          _this25._isNativeSelect = nodeName === 'select';
          _this25._isTextarea = nodeName === 'textarea';

          if (_this25._isNativeSelect) {
            _this25.controlType = element.multiple ? 'mat-native-select-multiple' : 'mat-native-select';
          }
          ...
          value: function ngAfterViewInit() {
            ...
            if (this._platform.isBrowser) {
              this._autofillMonitor.monitor(this._elementRef.nativeElement).subscribe(function (event) {
                _this26.autofilled = event.isAutofilled;
    ...
    /***/
    "rDax": function rDax(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CloseScrollStrategy = /*#__PURE__*/function () {
        function CloseScrollStrategy(_scrollDispatcher, _ngZone, _viewportRuler, _config) {
          ...
          this._detach = function () {
            ...
            if (_this27._overlayRef.hasAttached()) {
              _this27._ngZone.run(function () {
                return _this27._overlayRef.detach();
              });
            }
          };
        }
          ...
          value: function enable() {
            ...
            if (this._config && this._config.threshold && this._config.threshold > 1) {
              ...
              this._scrollSubscription = stream.subscribe(function () {
                var scrollPosition = _this28._viewportRuler.getViewportScrollPosition().top;

                if (Math.abs(scrollPosition - _this28._initialScrollPosition) > _this28._config.threshold) {
                  _this28._detach();
                } else {
                  _this28._overlayRef.updatePosition();
                }
              });
            } else {
          ...
          value: function enable() {
            ...
            if (!this._scrollSubscription) {
              ...
              this._scrollSubscription = this._scrollDispatcher.scrolled(throttle).subscribe(function () {
                _this29._overlayRef.updatePosition(); // TODO(crisbeto): make `close` on by default once all components can handle it.


                if (_this29._config && _this29._config.autoClose) {
                  var overlayRect = _this29._overlayRef.overlayElement.getBoundingClientRect();

                  var _this29$_viewportRule = _this29._viewportRuler.getViewportSize(),
                      width = _this29$_viewportRule.width,
                      height = _this29$_viewportRule.height; // TODO(crisbeto): include all ancestor scroll containers here once
      ...
      var ScrollStrategyOptions = function ScrollStrategyOptions(_scrollDispatcher, _viewportRuler, _ngZone, document) {
        ...
        this.close = function (config) {
          return new CloseScrollStrategy(_this30._scrollDispatcher, _this30._ngZone, _this30._viewportRuler, config);
        };
        /** Block scrolling. */


        this.block = function () {
          return new BlockScrollStrategy(_this30._viewportRuler, _this30._document);
        };
        /**
        ...
        this.reposition = function (config) {
          return new RepositionScrollStrategy(_this30._scrollDispatcher, _this30._viewportRuler, _this30._ngZone, config);
        };
      ...
      var OverlayKeyboardDispatcher = /*#__PURE__*/function (_BaseOverlayDispatche) {
        ...
        function OverlayKeyboardDispatcher(document) {
          ...
          _this31 = _super17.call(this, document);
          /** Keyboard event listener that will be attached to the body. */

          _this31._keydownListener = function (event) {
            var overlays = _this31._attachedOverlays;
      ...
      var OverlayOutsideClickDispatcher = /*#__PURE__*/function (_BaseOverlayDispatche2) {
        ...
        function OverlayOutsideClickDispatcher(document, _platform) {
          ...
          _this32 = _super18.call(this, document);
          _this32._platform = _platform;
          _this32._cursorStyleIsSet = false;
          /** Click event listener that will be attached to the body propagate phase. */

          _this32._clickListener = function (event) {
            ...
            var overlays = _this32._attachedOverlays.slice(); // Dispatch the mouse event to the top overlay which has subscribers to its mouse events.
        ...
        _createClass(OverlayRef, [{
          ...
          value: function detachBackdrop() {
            ...
            var finishDetach = function finishDetach() {
              ...
              if (_this36._config.backdropClass) {
                _this36._toggleClasses(backdropToDetach, _this36._config.backdropClass, false);
              }
          ...
          value: function _detachContentWhenStable() {
            ...
            this._ngZone.runOutsideAngular(function () {
              ...
              var subscription = _this37._ngZone.onStable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(_this37._attachments, _this37._detachments))).subscribe(function () {
        ...
        _createClass(CdkConnectedOverlay, [{
          ...
          value: function _createOverlay() {
            ...
            this._attachSubscription = overlayRef.attachments().subscribe(function () {
              return _this41.attach.emit();
            });
            this._detachSubscription = overlayRef.detachments().subscribe(function () {
              return _this41.detach.emit();
            });
            overlayRef.keydownEvents().subscribe(function (event) {
              _this41.overlayKeydown.next(event);

              if (event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_9__["ESCAPE"] && !_this41.disableClose && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_9__["hasModifierKey"])(event)) {
                event.preventDefault();
            ...
            this._overlayRef.outsidePointerEvents().subscribe(function (event) {
              _this41.overlayOutsideClick.next(event);
            });
          }
          ...
          value: function _attachOverlay() {
            ...
            if (this.hasBackdrop) {
              this._backdropSubscription = this._overlayRef.backdropClick().subscribe(function (event) {
                _this43.backdropClick.emit(event);
              });
            } else {
              this._backdropSubscription.unsubscribe();
            }
            ...
            if (this.positionChange.observers.length > 0) {
              this._positionSubscription = this._position.positionChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () {
                return _this43.positionChange.observers.length > 0;
              })).subscribe(function (position) {
                _this43.positionChange.emit(position);

                if (_this43.positionChange.observers.length === 0) {
                  _this43._positionSubscription.unsubscribe();
                }
              });
            }
          }
        ...
        _createClass(FullscreenOverlayContainer, [{
          ...
          value: function _createContainer() {
            ...
            this._addFullscreenChangeListener(function () {
              return _this44._adjustParentForFullscreenChange();
            });
          }
        }, {
    ...
    /***/
    "vxfF": function vxfF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(ScrollDispatcher, [{
          ...
          value: function register(scrollable) {
            ...
            if (!this.scrollContainers.has(scrollable)) {
              this.scrollContainers.set(scrollable, scrollable.elementScrolled().subscribe(function () {
                return _this45._scrolled.next(scrollable);
              }));
            }
          }
          /**
          ...
          value: function scrolled() {
            ...
            return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
              if (!_this46._globalSubscription) {
                _this46._addGlobalListener();
              } // In the case of a 0ms delay, use an observable without auditTime
              // since it does add a perceptible delay in processing overhead.


              var subscription = auditTimeInMs > 0 ? _this46._scrolled.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["auditTime"])(auditTimeInMs)).subscribe(observer) : _this46._scrolled.subscribe(observer);
              _this46._scrolledCount++;
              return function () {
                subscription.unsubscribe();
                _this46._scrolledCount--;

                if (!_this46._scrolledCount) {
                  _this46._removeGlobalListener();
                }
              };
            });
          }
          ...
          value: function ngOnDestroy() {
            ...
            this.scrollContainers.forEach(function (_, container) {
              return _this47.deregister(container);
            });
          ...
          value: function getAncestorScrollContainers(elementOrElementRef) {
            ...
            this.scrollContainers.forEach(function (_subscription, scrollable) {
              if (_this48._scrollableContainsElement(scrollable, elementOrElementRef)) {
      ...
      var CdkScrollable = /*#__PURE__*/function () {
        function CdkScrollable(elementRef, scrollDispatcher, ngZone, dir) {
          ...
          this._elementScrolled = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            return _this50.ngZone.runOutsideAngular(function () {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(_this50.elementRef.nativeElement, 'scroll').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this50._destroyed)).subscribe(observer);
            });
          });
        }
      ...
      var ViewportRuler = /*#__PURE__*/function () {
        function ViewportRuler(_platform, ngZone, document) {
          ...
          this._changeListener = function (event) {
            _this51._change.next(event);
          };

          this._document = document;
          ngZone.runOutsideAngular(function () {
            if (_platform.isBrowser) {
              var _window = _this51._getWindow(); // Note that bind the events ourselves, rather than going through something like RxJS's
              // `fromEvent` so that we can ensure that they're bound outside of the NgZone.


              _window.addEventListener('resize', _this51._changeListener);

              _window.addEventListener('orientationchange', _this51._changeListener);
            } // We don't need to keep track of the subscription,
            // because we complete the `change` stream on destroy.


            _this51.change().subscribe(function () {
      ...
      var CdkVirtualScrollViewport = /*#__PURE__*/function (_CdkScrollable) {
        ...
        var _super20 = _createSuper(CdkVirtualScrollViewport);
        ...
        function CdkVirtualScrollViewport(elementRef, _changeDetectorRef, ngZone, _scrollStrategy, dir, scrollDispatcher, viewportRuler) {
          ...
          _this52 = _super20.call(this, elementRef, scrollDispatcher, ngZone, dir);
          _this52.elementRef = elementRef;
          _this52._changeDetectorRef = _changeDetectorRef;
          _this52._scrollStrategy = _scrollStrategy;
          /** Emits when the viewport is detached from a CdkVirtualForOf. */

          _this52._detachedSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
          /** Emits when the rendered range changes. */

          _this52._renderedRangeSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
          _this52._orientation = 'vertical'; // Note: we don't use the typical EventEmitter here because we need to subscribe to the scroll
          ...
          _this52.scrolledIndexChange = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            return _this52._scrollStrategy.scrolledIndexChange.subscribe(function (index) {
              return Promise.resolve().then(function () {
                return _this52.ngZone.run(function () {
          ...
          _this52.renderedRangeStream = _this52._renderedRangeSubject;
          /**
           * The total size of all content (in pixels), including content that is not currently rendered.
           */

          _this52._totalContentSize = 0;
          /** A string representing the `style.width` property value to be used for the spacer element. */

          _this52._totalContentWidth = '';
          /** A string representing the `style.height` property value to be used for the spacer element. */

          _this52._totalContentHeight = '';
          /** The currently rendered range of indices. */

          _this52._renderedRange = {
            start: 0,
            end: 0
          };
          /** The length of the data bound to this viewport (in number of items). */

          _this52._dataLength = 0;
          /** The size of the viewport (in pixels). */

          _this52._viewportSize = 0;
          /** The last rendered content offset that was set. */

          _this52._renderedContentOffset = 0;
          /**
           * Whether the last rendered content offset was to the end of the content (and therefore needs to
           * be rewritten as an offset to the start of the content).
           */

          _this52._renderedContentOffsetNeedsRewrite = false;
          /** Whether there is a pending change detection cycle. */

          _this52._isChangeDetectionPending = false;
          /** A list of functions to run after the next change detection cycle. */

          _this52._runAfterChangeDetection = [];
          /** Subscription to changes in the viewport size. */

          _this52._viewportChanges = rxjs__WEBPACK_IMPORTED_MODULE_2__["Subscription"].EMPTY;

          if (!_scrollStrategy && (typeof ngDevMode === 'undefined' || ngDevMode)) {
            throw Error('Error: cdk-virtual-scroll-viewport requires the "itemSize" property to be set.');
          }

          _this52._viewportChanges = viewportRuler.change().subscribe(function () {
            _this52.checkViewportSize();
          });
          return _this52;
        }
        ...
        _createClass(CdkVirtualScrollViewport, [{
          ...
          value: function ngOnInit() {
            ...
            this.ngZone.runOutsideAngular(function () {
              return Promise.resolve().then(function () {
                _this53._measureViewportSize();

                _this53._scrollStrategy.attach(_this53);

                _this53.elementScrolled().pipe( // Start off with a fake scroll event so we properly detect our initial position.
                ...
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["auditTime"])(0, SCROLL_SCHEDULER)).subscribe(function () {
                  return _this53._scrollStrategy.onContentScrolled();
                });

                _this53._markChangeDetectionNeeded();
              });
            });
          }
        }, {
          ...
          value: function attach(forOf) {
            ...
            this.ngZone.runOutsideAngular(function () {
              _this54._forOf = forOf;

              _this54._forOf.dataStream.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this54._detachedSubject)).subscribe(function (data) {
                var newLength = data.length;

                if (newLength !== _this54._dataLength) {
                  _this54._dataLength = newLength;

                  _this54._scrollStrategy.onDataLengthChanged();
                }

                _this54._doChangeDetection();
              });
            });
          }
          ...
          value: function setRenderedRange(range) {
            ...
            if (!rangesEqual(this._renderedRange, range)) {
              ...
              this._markChangeDetectionNeeded(function () {
                return _this55._scrollStrategy.onContentRendered();
              });
            }
          }
          /**
          ...
          value: function setRenderedContentOffset(offset) {
            ...
            if (this._renderedContentTransform != transform) {
              ...
              this._markChangeDetectionNeeded(function () {
                if (_this56._renderedContentOffsetNeedsRewrite) {
                  _this56._renderedContentOffset -= _this56.measureRenderedContentSize();
                  _this56._renderedContentOffsetNeedsRewrite = false;

                  _this56.setRenderedContentOffset(_this56._renderedContentOffset);
                } else {
                  _this56._scrollStrategy.onRenderedOffsetChanged();
                }
              });
            }
          }
      ...
      var CdkVirtualForOf = /*#__PURE__*/function () {
        ...
        _viewport, ngZone) {
          ...
          Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (_ref) {
            ...
            return _this59._changeDataSource(prev, cur);
          ...
          this._viewport.renderedRangeStream.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this._destroyed)).subscribe(function (range) {
            _this59._renderedRange = range;
            ngZone.run(function () {
              return _this59.viewChange.next(_this59._renderedRange);
            });
        ...
        _createClass(CdkVirtualForOf, [{
          ...
          set: function set(fn) {
            ...
            this._cdkVirtualForTrackBy = fn ? function (index, item) {
              return fn(index + (_this60._renderedRange ? _this60._renderedRange.start : 0), item);
            } : undefined;
          }
          ...
          value: function _onRenderedDataChange() {
            ...
            if (!this._differ) {
              ...
              this._differ = this._differs.find(this._renderedItems).create(function (index, item) {
                return _this61.cdkVirtualForTrackBy ? _this61.cdkVirtualForTrackBy(index, item) : item;
              });
            }
          ...
          value: function _applyChanges(changes) {
            ...
            this._viewRepeater.applyChanges(changes, this._viewContainerRef, function (record, _adjustedPreviousIndex, currentIndex) {
              return _this62._getEmbeddedViewArgs(record, currentIndex);
            }, function (record) {
              return record.item;
            ...
            changes.forEachIdentityChange(function (record) {
              var view = _this62._viewContainerRef.get(record.currentIndex);
...
//# sourceMappingURL=default~modules-asset-asset-module~modules-material-material-module-es5.js.map