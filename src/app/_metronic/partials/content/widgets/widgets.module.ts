...
import { QuickLinksWidgetsComponent } from './asset-module/quick-links-widgets/quick-links-widgets.component';
import { DealInfoWidgetComponent } from './asset-module/deal-info-widget/deal-info-widget.component';
import { DealStatisticsWidgetComponent } from './asset-module/deal-statistics-widget/deal-statistics-widget.component';
...
@NgModule({
  declarations: [
    ...
    QuickLinksWidgetsComponent,
    DealInfoWidgetComponent,
    DealStatisticsWidgetComponent
  ],
  imports: [
    CommonModule,
    DropdownMenusModule,
